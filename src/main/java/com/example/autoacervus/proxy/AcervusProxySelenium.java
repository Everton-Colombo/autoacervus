...
public class AcervusProxySelenium implements AcervusProxy {
    ...
    private static final String loggedOutRedirectUrl = "https://acervus.unicamp.br/Login/Login";
    ...
    public boolean login(User user) {
        ...
        WebElement signinBtn = driver.findElement(By.cssSelector("a[title='Entrar']"));
        signinBtn.click();

        driver.switchTo().frame(driver.findElement(By.cssSelector("#loginWindow > iframe")));
        WebElement loginField = driver.findElement(By.name("identificacao"));
        WebElement pwField = driver.findElement(By.name("senha"));
        WebElement enterBtn = driver.findElement(By.cssSelector("button[type='submit']"));
...
//        borrowedBook.setBorrowDate(borrowDate);
    ...
    private List<BorrowedBookEntry> getBorrowedBookEntries() throws LoginException {
